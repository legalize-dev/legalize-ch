...
<sup>7</sup> eine Firmennummer zu.

<sup>8</sup> Entzug der Zulassung Art. 9 (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Die OZD entzieht die Zulassung zur Verwendung des Systems «e-dec», des Systems «NCTS» beziehungsweise beider Systeme, wenn die Person:
...
<sup>9</sup> Art. 10 Meldung von Personen, die Zollanmeldungen ausstellen (Art. <sup>28</sup> Abs. <sup>2</sup> und <sup>109</sup> Abs. <sup>1</sup> ZG)
...
<sup>10</sup> Identifikation der Personen, die Zollanmeldungen ausstellen Art. 11 (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Personen, die Zollanmeldungen mit den Systemen «e-dec» und «NCTS» ausstellen, müssen in der Zollanmeldung die ihnen zugeteilte Firmenund Personennummer angeben.
...
<sup>11</sup> der Daten an die Systeme «e-dec» und «NCTS» benötigt.
...
<sup>13</sup> «NCTS» (Art. <sup>28</sup> Abs. <sup>2</sup> ZG)
...
<sup>14</sup> me «e-dec» und «NCTS». Diese muss die Änderungen fristgerecht umsetzen.

<sup>15</sup> Kosten Art. <sup>15</sup> (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Die anmeldepflichtige Person trägt die Kosten für:
...
<sup>16</sup> Art. <sup>16</sup> Annahme der Zollanmeldung (Art. <sup>33</sup> Abs. <sup>2</sup> ZG) Die Zollanmeldung gilt als angenommen, wenn sie die summarische Prüfung des Systems «e-dec» beziehungsweise des Systems «NCTS» erfolgreich durchlaufen hat. Das System fügt der elektronischen Zollanmeldung Annahmedatum und Annahmezeit hinzu.

<sup>17</sup> Art. <sup>17</sup> Selektion bei der Einfuhr (Art. <sup>25</sup> Abs. 1, <sup>35</sup> Abs. <sup>1</sup> und <sup>40</sup> Abs. <sup>1</sup> ZG)

<sup>1</sup> Nach der Annahme der Zollanmeldung führt das System «e-dec» eine Selektion

<sup>18</sup> auf der Grundlage einer Risikoanalyse durch.
...
<sup>19</sup> die EZV als freigegeben.
...
<sup>20</sup> b. nachweisen, dass die Auflagen der Kontrollorgane erfüllt sind.

<sup>21</sup> Selektion bei der Ausfuhr Art. 17 a (Art. <sup>25</sup> Abs. 1, <sup>35</sup> Abs. <sup>1</sup> und <sup>40</sup> Abs. <sup>1</sup> ZG)
...
<sup>22</sup> Art. 19 Fristen zur Vorlage der Dokumente bei der Einfuhr (Art. <sup>25</sup> Abs. <sup>1</sup> und <sup>35</sup> Abs. <sup>1</sup> ZG)
...
<sup>23</sup> Art. 19 a Fristen zur Vorlage der Dokumente bei der Ausfuhr (Art. <sup>25</sup> Abs. <sup>1</sup> und <sup>35</sup> Abs. <sup>1</sup> ZG)
...
<sup>24</sup> begründeten Fällen kann die Zollstelle diese Frist verlängern.
...
<sup>25</sup> Bemessungsgrundlagen an, die für die betreffenden Waren anwendbar sind.

<sup>26</sup> Eröffnung der Veranlagungsverfügung Art. 20 a (Art. <sup>38</sup> ZG; Art. <sup>92</sup> ZV)
...
<sup>27</sup> Art. 20 b Rückgabe der Veranlagungsverfügung (Art. <sup>174</sup> ZV)
...
<sup>34</sup> e. bei der Überführung in das Ausfuhrverfahren (Art. 61 ZG) von Waren nach Buchstabe a, mit Ausnahme der Ziffern 7–9, 15, 16 und 19;
...
<sup>35</sup> Art. 23 a Benutzen der Anmeldebox (Art. <sup>28</sup> Abs. <sup>1</sup> Bst. b ZG) Wer Waren des Reiseverkehrs einoder ausführt, hat die Zollanmeldung in einer von der Zollkreisdirektion zugelassenen Anmeldebox zu deponieren, falls die mündliche Zollanmeldung oder die Zollanmeldung durch eine andere Form der Willensäusserung nicht möglich oder nicht zugelassen ist.

<sup>36</sup> Art. 24 Annahme der Zollanmeldung in Papierform (Art. <sup>33</sup> Abs. <sup>2</sup> ZG) Die Zollanmeldung in Papierform gilt als angenommen, wenn:
...
<sup>37</sup> Art. 24 a Voranmeldung im landwirtschaftlichen Bewirtschaftungsverkehr (Art. <sup>25</sup> Abs. <sup>1</sup> und 3, <sup>28</sup> Abs. <sup>1</sup> und <sup>2</sup> sowie <sup>43</sup> Abs. <sup>1</sup> Bst. a ZG; Art. <sup>118</sup> ZV)
...
#### 5. Abschnitt: Mündliche Zollanmeldung <sup>38</sup>

##### **Art. 25** Geltungsbereich

(Art. <sup>28</sup> Abs. <sup>1</sup> Bst. c ZG)

<sup>1</sup> <sup>39</sup> Die mündliche Zollanmeldung ist zulässig für:

- a. Waren des Reiseverkehrs;

- b. immatrikulierte Beförderungsmittel, für die Anlage C des Übereinkommens

<sup>40</sup> vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt;

<sup>41</sup> c. ausländische Sachentransportanhänger, die nach Artikel 34 Absatz 3 ZV für grenzüberschreitende Beförderungen vorübergehend verwendet werden dürfen;

<sup>42</sup> d. in Grenzgewässern gefangene frische Fische (Art. 26 ZV).
...
#### 6. Abschnitt: Zollanmeldung bei grünem Durchgang <sup>43</sup>
...
#### 7. Abschnitt: Grüne Sichtzollanmeldung im Strassenverkehr <sup>44</sup>
...
<sup>45</sup> führt, für das Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt, und wenn alle mitgeführten Waren:
...
#### 9. Abschnitt: Zollanmeldung bei Zollstrassen mit Zollanmeldungstafel <sup>47</sup>
...
<sup>48</sup> Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt.
...
<sup>49</sup> Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt.
...
<sup>50</sup> das ungestempelte Bezugsdokument für die vom System «e-dec», vom Anc. wendungsbereich Ausfuhr des Systems «NCTS» beziehungsweise von der Internetapplikation «e-dec web» freigegebenen Waren.
...
<sup>51</sup> nach der Gestellung bei der Kontrollzollstelle anmelden.

<sup>2</sup> Im Übrigen gilt Artikel 4 Absatz 2.

##### **Art. 39** Zahlungsweise

(Art. <sup>42</sup> Abs. <sup>1</sup> Bst. a und d sowie <sup>73</sup> Abs. <sup>3</sup> ZG; Art. <sup>15</sup> Abs. <sup>1</sup> Bst. a der Zollverordnung 52) des EFD vom 4. April <sup>2007</sup> Die zugelassene Versenderin oder der zugelassene Versender beziehungsweise die zugelassene Empfängerin oder der zugelassene Empfänger muss die Zollschuld bargeldlos gegen Rechnung im Rahmen des Zentralisierten Abrechnungsverfahrens der EZV (ZAZ) bezahlen.
...
<sup>53</sup> der Kontrollzollstelle vorlegen:
...
<sup>54</sup> b. den Mitarbeiterinnen und Mitarbeitern der Sektion Zollfahndung der Zollkreisdirektionen und der Abteilung Strafsachen der OZD;
...
<sup>55</sup> 1. Verordnung der Oberzolldirektion vom 19. November 1987 über Privatlagerwaren;

<sup>56</sup> 2. Reglement der Oberzolldirektion vom 25. Oktober 1967 über die Zollbehandlung des vom Bund eingeführten Zivilschutzmaterials.
...
[^33]: Aufgehoben durch Ziff. I der V der EZV vom 25. Febr. 2015, mit Wirkung seit 1. Mai 2015 (AS 2015 853).

[^34]: Fassung gemäss Ziff. I der V der EZV vom 23. Juni 2014, in Kraft seit 1. Aug. 2014 (AS 2014 2307).

[^35]: Eingefügt durch Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^36]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^37]: Eingefügt durch Ziff. I der V der EZV vom 11. April 2008, in Kraft seit 1. Mai 2008 (AS 2008 1811).

[^38]: Urspünglich 4. Abschnitt.

[^39]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^40]: SR 0.631.24

[^41]: Eingefügt durch Ziff. I der V der EZV vom 16. Dez. 2010 (AS 2011 5). Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^42]: Eingefügt durch Ziff. I der V der EZV vom 23. Juni 2014, in Kraft seit 1. Aug. 2014 (AS 2014 2307).

[^43]: Urspünglich 5. Abschnitt.

[^44]: Urspünglich 6. Abschnitt.

[^45]: SR 0.631.24

[^46]: Urspünglich 7. Abschnitt.

[^47]: Urspünglich 8. Abschnitt.
...
[^51]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^52]: SR 631.011

[^53]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^54]: Fassung gemäss Ziff. I der V der EZV vom 16. Dez. 2010, in Kraft seit 1. Jan. 2011 (AS 2011 5).
