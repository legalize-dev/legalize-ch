...
(Art. <sup>112</sup> r ZV) Die summarische Einund Ausgangsanmeldung zu Sicherheitszwecken erfolgt elektronisch nach den Artikeln 7–9 und 11–17 a .

##### **Art. 7** Sprache

(Art. <sup>28</sup> ZG) Die Zollanmeldung erfolgt in einer Amtssprache des Bundes.

#### 2. Abschnitt: <sup>4</sup>

Elektronische Zollanmeldung mit den Systemen «e-dec» und «NCTS» <sup>5</sup>

<sup>6</sup> Art. 8 Zulassung zur Verwendung der Systeme «e-dec» und «NCTS» (Art. <sup>28</sup> Abs. <sup>2</sup> ZG)
...
<sup>6</sup> Die OZD teilt der anmeldepflichtigen Person eine Firmennummer zu.

<sup>7</sup> Entzug der Zulassung Art. 9 (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Die OZD entzieht die Zulassung zur Verwendung des Systems «e-dec», des Systems «NCTS» beziehungsweise beider Systeme, wenn die Person:
...
<sup>8</sup> Art. 10 Meldung von Personen, die Zollanmeldungen ausstellen (Art. <sup>28</sup> Abs. <sup>2</sup> und <sup>109</sup> Abs. <sup>1</sup> ZG)
...
<sup>9</sup> Art. 11 Identifikation der Personen, die Zollanmeldungen ausstellen (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Personen, die Zollanmeldungen mit den Systemen «e-dec» und «NCTS» ausstellen, müssen in der Zollanmeldung die ihnen zugeteilte Firmenund Personennummer angeben.
...
<sup>10</sup> der Daten an die Systeme «e-dec» und «NCTS» benötigt.
...
<sup>12</sup> «NCTS» (Art. <sup>28</sup> Abs. <sup>2</sup> ZG)
...
<sup>13</sup> me «e-dec» und «NCTS». Diese muss die Änderungen fristgerecht umsetzen.

<sup>14</sup> Kosten Art. 15 (Art. <sup>28</sup> Abs. <sup>2</sup> ZG) Die anmeldepflichtige Person trägt die Kosten für:
...
<sup>15</sup> Annahme der Zollanmeldung Art. 16 (Art. <sup>33</sup> Abs. <sup>2</sup> ZG) Die Zollanmeldung gilt als angenommen, wenn sie die summarische Prüfung des Systems «e-dec» beziehungsweise des Systems «NCTS» erfolgreich durchlaufen hat. Das System fügt der elektronischen Zollanmeldung Annahmedatum und Annahmezeit hinzu.

<sup>16</sup> Art. 17 Selektion bei der Einfuhr (Art. <sup>25</sup> Abs. 1, <sup>35</sup> Abs. <sup>1</sup> und <sup>40</sup> Abs. <sup>1</sup> ZG)

<sup>1</sup> Nach der Annahme der Zollanmeldung führt das System «e-dec» eine Selektion

<sup>17</sup> auf der Grundlage einer Risikoanalyse durch.
...
<sup>18</sup> die EZV als freigegeben.
...
<sup>19</sup> b. nachweisen, dass die Auflagen der Kontrollorgane erfüllt sind.

<sup>20</sup> Art. 17 a Selektion bei der Ausfuhr (Art. <sup>25</sup> Abs. 1, <sup>35</sup> Abs. <sup>1</sup> und <sup>40</sup> Abs. <sup>1</sup> ZG)
...
<sup>21</sup> Art. 19 Fristen zur Vorlage der Dokumente bei der Einfuhr (Art. <sup>25</sup> Abs. <sup>1</sup> und <sup>35</sup> Abs. <sup>1</sup> ZG)
...
<sup>22</sup> Fristen zur Vorlage der Dokumente bei der Ausfuhr Art. 19 a (Art. <sup>25</sup> Abs. <sup>1</sup> und <sup>35</sup> Abs. <sup>1</sup> ZG)
...
<sup>23</sup> begründeten Fällen kann die Zollstelle diese Frist verlängern.

<sup>3</sup> Reicht die anmeldepflichtige Person die berichtigte oder ergänzte Zollanmeldung nicht fristgerecht ein, so:

- a. kann die Zollstelle bei der Einfuhr auf die Waren den höchsten Zollansatz und die höchsten Bemessungsgrundlagen, die nach ihrer Art anwendbar sind, anwenden;

<sup>24</sup> b. annulliert die Zollstelle die Ausfuhrzollanmeldung.

<sup>25</sup> Art. 20 a Eröffnung der Veranlagungsverfügung (Art. <sup>38</sup> ZG; Art. <sup>92</sup> ZV)
...
<sup>26</sup> Art. 20 b Rückgabe der Veranlagungsverfügung (Art. <sup>174</sup> ZV)
...
#### 4. Abschnitt: Zollanmeldung in Papierform <sup>28</sup>

<sup>29</sup> Art. 21 Geltungsbereich (Art. <sup>28</sup> Abs. <sup>1</sup> Bst. b ZG) Die Zollanmeldung in Papierform ist zulässig:
...
<sup>30</sup> 2007 ), sofern sie keinen Abgaben unterliegen, 19. Waren aus den Freizonen Hochsavoyen und der Landschaft Gex, sofern sie über eine Bewilligung der Zollkreisdirektion Genf verfügen, 20. anderen Waren in geringen Mengen, sofern sie keinen Abgaben unterliegen und nicht für den Handel bestimmt sind;

- b. bei der Überführung von Waren in das Transitverfahren (Art. 49 ZG);
...
- e. bei der Überführung in das Ausfuhrverfahren (Art. 61 ZG) von Waren nach Buchstabe a, die nicht für den Handel bestimmt sind, mit Ausnahme der Ziffern 9–11, 15, 17–18 und 21;
...
<sup>31</sup> Art. 23 a Benutzen der Anmeldebox (Art. <sup>28</sup> Abs. <sup>1</sup> Bst. b ZG) Wer Waren des Reiseverkehrs einoder ausführt, hat die Zollanmeldung in einer von der Zollkreisdirektion zugelassenen Anmeldebox zu deponieren, falls die mündliche Zollanmeldung oder die Zollanmeldung durch eine andere Form der Willensäusserung nicht möglich oder nicht zugelassen ist.

<sup>32</sup> Art. 24 Annahme der Zollanmeldung in Papierform (Art. <sup>33</sup> Abs. <sup>2</sup> ZG) Die Zollanmeldung in Papierform gilt als angenommen, wenn:
...
<sup>33</sup> Art. 24 a Voranmeldung im landwirtschaftlichen Bewirtschaftungsverkehr (Art. <sup>25</sup> Abs. <sup>1</sup> und 3, <sup>28</sup> Abs. <sup>1</sup> und <sup>2</sup> sowie <sup>43</sup> Abs. <sup>1</sup> Bst. a ZG; Art. <sup>118</sup> ZV)
...
#### 5. Abschnitt: Mündliche Zollanmeldung <sup>34</sup>

##### **Art. 25** Geltungsbereich

(Art. <sup>28</sup> Abs. <sup>1</sup> Bst. c ZG)

<sup>1</sup> <sup>35</sup> Die mündliche Zollanmeldung ist zulässig für:

- a. Waren des Reiseverkehrs;

- b. immatrikulierte Beförderungsmittel, für die Anlage C des Übereinkommens

<sup>36</sup> vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt;

<sup>37</sup> c. ausländische Sachentransportanhänger, die nach Artikel 34 Absatz 3 ZV für grenzüberschreitende Beförderungen vorübergehend verwendet werden dürfen.
...
#### 6. Abschnitt: Zollanmeldung bei grünem Durchgang <sup>38</sup>
...
#### 7. Abschnitt: Grüne Sichtzollanmeldung im Strassenverkehr <sup>39</sup>
...
<sup>40</sup> führt, für das Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt, und wenn alle mitgeführten Waren:
...
#### 9. Abschnitt: Zollanmeldung bei Zollstrassen mit Zollanmeldungstafel <sup>42</sup>
...
<sup>43</sup> Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt.
...
<sup>44</sup> Anlage C des Übereinkommens vom 26. Juni 1990 über die vorübergehende Verwendung weder eine Zollanmeldung noch eine Sicherheitsleistung verlangt.
...
<sup>45</sup> das ungestempelte Bezugsdokument für die vom System «e-dec», vom c. Anwendungsbereich Ausfuhr des Systems «NCTS» beziehungsweise von der Internetapplikation «e-dec web» freigegebenen Waren.
...
<sup>46</sup> nach der Gestellung bei der Kontrollzollstelle anmelden.
...
<sup>47</sup> ) des EFD vom 4. April <sup>2007</sup> Die zugelassene Versenderin oder der zugelassene Versender beziehungsweise die zugelassene Empfängerin oder der zugelassene Empfänger muss die Zollschuld bargeldlos gegen Rechnung im Rahmen des Zentralisierten Abrechnungsverfahrens der EZV (ZAZ) bezahlen.
...
<sup>48</sup> der Kontrollzollstelle vorlegen:
...
<sup>49</sup> b. den Mitarbeiterinnen und Mitarbeitern der Sektion Zollfahndung der Zollkreisdirektionen und der Abteilung Strafsachen der OZD;
...
<sup>50</sup> 1. Verordnung der Oberzolldirektion vom 19. November 1987 über Privatlagerwaren;

<sup>51</sup> 2. Reglement der Oberzolldirektion vom 25. Oktober 1967 über die Zollbehandlung des vom Bund eingeführten Zivilschutzmaterials.
...
[^7]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).
...
[^20]: Eingefügt durch Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^21]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^22]: Eingefügt durch Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^23]: Fassung gemäss Ziff. I der V der EZV vom 10. April 2008, in Kraft seit 1. Juli 2008 (AS 2008 2119).

[^24]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^25]: Eingefügt durch Ziff. I der V der EZV vom 27. Febr. 2009 (AS 2009 1147). Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).
...
[^27]: Eingefügt durch Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^28]: Ursprünglich 3. Abschnitt.

[^29]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^30]: SR 631.011

[^31]: Eingefügt durch Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^32]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^33]: Eingefügt durch Ziff. I der V der EZV vom 11. April 2008, in Kraft seit 1. Mai 2008 (AS 2008 1811).

[^34]: Urspünglich 4. Abschnitt.

[^35]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^36]: SR 0.631.24

[^37]: Eingefügt durch Ziff. I der V der EZV vom 16. Dez. 2010 (AS 2011 5). Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^38]: Urspünglich 5. Abschnitt.

[^39]: Urspünglich 6. Abschnitt.

[^40]: SR 0.631.24

[^41]: Urspünglich 7. Abschnitt.

[^42]: Urspünglich 8. Abschnitt.

[^43]: SR 0.631.24

[^44]: SR 0.631.24

[^45]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^46]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^47]: SR 631.011

[^48]: Fassung gemäss Ziff. I der V der EZV vom 10. Dez. 2012, in Kraft seit 1. Febr. 2013 (AS 2013 219).

[^49]: Fassung gemäss Ziff. I der V der EZV vom 16. Dez. 2010, in Kraft seit 1. Jan. 2011 (AS 2011 5).

[^50]: [AS 1987 2668]

[^51]: In der AS nicht veröffentlicht.
