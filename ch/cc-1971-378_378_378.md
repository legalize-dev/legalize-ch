...
- b) Amtliche Texte der Internationalen Klassifikation werden nach Konsultierung der beteiligten Regierungen von dem im Übereinkommen zur Errichtung der Weltorganisation für geistiges Eigentum[^1] (im folgenden als «die Organisation» bezeichnet) vorgesehenen Internationalen Büro für geistiges Eigentum (im folgenden als «das Internationale Büro» bezeichnet) in anderen Sprachen hergestellt, die die in Artikel 5 bezeichnete Versammlung bestimmen kann.
...
- iv) legt das Programm fest, beschliesst den Zweijahres-Haushaltsplan[^2] des besonderen Verbandes und billigt seine Rechnungsabschlüsse;
...
- vii) bildet, zusätzlich zu dem in Artikel 3 genannten Sachverständigenausschuss, die anderen Sachverständigenausschüsse und Arbeitsgruppen, die sie zur Verwirklichung der Ziele des besonderen Verbandes für zweckdienlich hält;
...
- 4) a) Die Versammlung tritt nach Einberufung durch den Generaldirektor alle zwei Jahre[^3] einmal zu einer ordentlichen Tagung zusammen, und zwar, abgesehen von aussergewöhnlichen Fällen, zu derselben Zeit und an demselben Ort wie die Generalversammlung der Organisation.
...
1) Jedes Vertragsland der Pariser Verbandsübereinkunft zum Schutz des gewerblichen Eigentums[^4] kann dieses Abkommen ratifizieren, wenn es dieses unterzeichnet hat, oder ihm beitreten, wenn es dieses Abkommen nicht unterzeichnet hat.
...
Dieses Abkommen hat dieselbe Geltung und Dauer wie die Pariser Verbandsübereinkunft zum Schutz des gewerblichen Eigentums[^5].
...
Artikel 24 der Pariser Verbandsübereinkunft zum Schutz des gewerblichen Eigentums[^6] ist auf dieses Abkommen anzuwenden.
...
[^2]: Fassung dieser Worte gemäss Änderung vom 2. Okt. 1979, in Kraft für die Schweiz seit 23. Nov. 1981 ([AS **1983** 1092](https://fedlex.data.admin.ch/eli/oc/1983/1092_1092_1092)).

[^3]: Fassung dieser Worte gemäss Änderung vom 2. Okt. 1979, in Kraft für die Schweiz seit 23. Nov. 1981 ([AS **1983** 1092](https://fedlex.data.admin.ch/eli/oc/1983/1092_1092_1092)).

[^4]: SR. **0.232.01/04**

[^5]: SR. **0.232.01/04**

[^6]: [SR **0.232.04** ](https://fedlex.data.admin.ch/eli/cc/1970/620_620_620)und **[0.232.01](https://fedlex.data.admin.ch/eli/cc/45/243_255_253)/.03** Art. 16<sup>bis</sup>
