...
<sup>2</sup> festgelegten so genannten TIR-Verfahrens ;

<sup>3</sup> b) «TIR-Versand» den Streckenteil eines TIR-Transports, der in einer Vertragspartei von einem Abgangszollamt oder Eingangszollamt (Durchgangszollamt) bis zu einem Bestimmungszollamt oder Ausgangszollamt (Durchgangszollamt) erfolgt;
