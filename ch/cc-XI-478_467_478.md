---
title: "Staatsvertrag vom 23. Dezember 1873 zwischen der Schweiz und Italien betreffend die Verbindung der Gotthardbahn mit den italienischen Bahnen bei Chiasso und Pino (mit Prot.)"
identifier: "cc-XI-478_467_478"
country: "ch"
rank: "andere"
publication_date: "1873-12-23"
last_updated: "1873-12-23"
status: "in_force"
source: "https://fedlex.data.admin.ch/eli/cc/XI/478_467_478"
department: "Bundeskanzlei"
sr_number: "0.742.140.12"
entry_into_force: "1874-02-14"
applicability_date: "1874-02-14"
history_from: "1874-02-14"
title_it: "Convenzione del 23 dicembre 1873 tra la Svizzera e l'Italia per la congiunzione della ferrovia del Gottardo colle ferrovie italiane a Chiasso e a Pino (con Protocollo)"
title_fr: "Convention du 23 décembre 1873 entre la Suisse et l'Italie concernant le raccordement du chemin de fer du Saint Gothard avec les chemins de fer italiens près de Chiasso et de Pino (avec protocole)"
authoritative: "true"
...
Der Punkt an der Grenze bei Pino, wo der Anschluss der Gotthardbahn an das italienische Bahnnetz auf dem linken Ufer des Langensees stattfinden wird, soll, sobald die Vorstudien hinreichend fortgeschritten sind, festgesetzt werden.[^3]
...
Es soll für jede der beiden Linien Bellinzona–Chiasso–Camerlata und Bellinzona–Pino–Luino eine internationale Station errichtet werden, um darin den Zoll‑[^4], Post-, Telegrafen-, Polizei-[^5] und Gesundheitspolizeidienst der beiden Staaten zu vereinigen.

Diese Stationen werden in Chiasso und Luino erstellt.

##### **Art. 4**

Die in jeder der beiden internationalen Stationen sowie zwischen diesen Stationen und der Grenze von den beiden interessierten Regierungen für die genannten Dienstzweige als notwendig erkannten Lokale und Räumlichkeiten sind von den respektiven Bahngesellschaften[^6] unentgeltlich zur Verfügung zustellen.
...
Das für den durchgehenden Verkehr bestimmte Betriebsmaterial soll so konstruiert werden, dass es ohne Schwierigkeit von einem Bahnnetz auf das andere übergehen kann.[^7]
...
Die von einer der kontrahierenden Regierungen hinsichtlich ihrer Betriebsfähigkeit geprüften Lokomotiven und Wagen sollen ungehindert auf die im Gebiete des andern Staates liegenden Linien übergehen können.[^8]
...
Die nähern Formalitäten sollen zwischen den Zollverwaltungen der beiden Staaten, der Betriebseröffnung vorgängig, durch eine besondere Vereinbarung geregelt werden.[^9]
...
[^1]: [AS** X** 555. [SR **0.742.140.11** ](https://fedlex.data.admin.ch/eli/cc/29/349_317_337)Art. 1 Ziff. 1]. Heute: des Staatsvertrages vom 13. Okt. 1909 zwischen der Schweiz, Deutschland und Italien betreffend die Gotthardbahn ([SR **0.742.140.11**](https://fedlex.data.admin.ch/eli/cc/29/349_317_337)).

[^2]: Dieser Plan wurde in der AS nicht veröffentlicht.

[^3]: Siehe das Prot. vom 5. Febr. 1880 ([SR **0.742.140.121**](https://fedlex.data.admin.ch/eli/cc/5/49_49_49)).

[^4]: Für den Zolldienst siehe das Übereink. vom 15. Dez. 1882 ([SR** 0.631.252.945.43**](https://fedlex.data.admin.ch/eli/cc/7/193_180_191)).

[^5]: Für den Polizeidienst siehe die Übereink. vom 16. Febr. 1881 ([SR **0.742.140.13**](https://fedlex.data.admin.ch/eli/cc/5/577_522_779)) und die Erkl. vom 11. Nov. 1884/12. Jan. 1885 ([SR** 0.742.140.131**](https://fedlex.data.admin.ch/eli/cc/8/65_63_65)).

[^6]: Heute: Schweizerische Bundesbahnen bzw. Italienische Staatsbahnen (Ziff. I ad Art. 1 des Schlussprot. zum Staatsvertrag vom 13. Okt. 1909 – [SR** 0.742.140.11**](https://fedlex.data.admin.ch/eli/cc/29/349_317_337)).

[^7]: Die Schweiz und Italien sind der «Technischen Einheit im Eisenbahnwesen» beigetreten (V vom 16. Dez. 1938 – [SR **742.141.3**](https://fedlex.data.admin.ch/eli/cc/55/72_76_129)).

[^8]: Die Schweiz und Italien sind der «Technischen Einheit im Eisenbahnwesen» beigetreten (V vom 16. Dez. 1938 – [SR **742.141.3**](https://fedlex.data.admin.ch/eli/cc/55/72_76_129)).

[^9]: Siehe [SR **0.631.252.945.43**](https://fedlex.data.admin.ch/eli/cc/7/193_180_191)
